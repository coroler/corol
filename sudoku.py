...
class Solution(object):
    ...
    def insert(self):
        self.insert_rollback_return()
    
    def insert_rollback_return(self):
        ...
        if self.board[self.row][self.cloumn] == '.':
            ...
            return self.insert_rollback_return()
